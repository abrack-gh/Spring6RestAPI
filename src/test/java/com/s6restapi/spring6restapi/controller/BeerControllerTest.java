...
class BeerControllerTest {
    ...
    void testCreateNewBeer() throws Exception {
        ...
        given(beerService.saveBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null, false, 1, 25).get(1));
    ...
    void testBeerList() throws Exception {
        given(beerService.listBeers(any(), any(), any(), 1, 25)).willReturn(beerServiceImpl.listBeers(null, null, false, 1, 25));
